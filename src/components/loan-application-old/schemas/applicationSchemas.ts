...
// Define a Zod schema for the application form
export const applicationFormSchema = z.object({
  personalLoanId: z.string().optional(),
  userInfo: z.object({
    ...
    socialMediaLinks: z.array(z.string().url("Invalid URL").optional()).optional().default([""]),
