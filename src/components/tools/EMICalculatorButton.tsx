...
const EMICalculatorButton = () => {
  return (
    <div
      className="fixed right-0 top-[75%] z-50 origin-top-right rotate-90 cursor-pointer rounded-bl-md bg-gradient-to-br from-red-600 to-red-500 px-6 py-2 text-sm font-semibold tracking-wider text-white shadow-xl transition-all hover:scale-105 hover:brightness-110 lg:text-base xl:top-1/2"
